...
public class TwoOrMoreViewModelMockitoTest {
  ...
  @Test
  public void insufficientWager1() {
    m.setGameType(GameType.THREE_ALIKE);
    m.setBalance(8);
    m.setWager(3);
    assertThat(m.play(), is(GameResult.UNDECIDED));
  }

  @Test
  public void insufficientWager2() {
    m.setGameType(GameType.TWO_ALIKE);
    m.setBalance(0);
    m.setWager(1);
    assertThat(m.play(), is(GameResult.UNDECIDED));
